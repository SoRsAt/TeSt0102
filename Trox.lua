...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1558668590,1659386058}
Trox = Config.Trox
...
os.execute('wget https://raw.githubusercontent.com/Team-Trox-abdSource/Trox/master/Trox.lua') 
dofile('Trox.lua') 
...
Text = ''..TroxTeam[math.random(#TroxTeam)]..''
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ TeAm Trox .',url="t.me/XXXZZ"}}}
Msg_id = msg.id_/2097152/0.5
